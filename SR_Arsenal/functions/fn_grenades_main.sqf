/*
	...
	Description:
		...
		Else
			Checks if the player is carrying a recorded grenade.
			If so activates the CBA ace_firedPlayer event handler to handle its slow
	...
	if (missionNamespace getVariable ["ace_advanced_throwing_enabled", false]) then {
		...
		if ("SR_Mag_Rad_Grenade" in (magazines player)) then {
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Rad_Grenade"], -1]) == -1) then {
				missionNamespace setVariable [format ["%1_handler","SR_Mag_Rad_Grenade"], ["ace_firedPlayer", {
			...
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Rad_Grenade"], -1]) != -1) then {
				["ace_firedPlayer", (missionNamespace getVariable [format ["%1_handler","SR_Mag_Rad_Grenade"], -1])] call CBA_fnc_removeEventHandler;
		...
		if ("SR_Mag_Stasis_Grenade" in (magazines player)) then {
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Stasis_Grenade"], -1]) == -1) then {
				missionNamespace setVariable [format ["%1_handler","SR_Mag_Stasis_Grenade"], ["ace_firedPlayer", {
					// params ["_unit", "_weapon", "_muzzle", "_mode", "_ammo", "_magazine", "_projectile", "_gunner"];
					_weapon = (_this select 1);
					if (_weapon == "Throw") then {
						_projectile = (_this select 6);
			...
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Stasis_Grenade"], -1]) != -1) then {
				["ace_firedPlayer", (missionNamespace getVariable [format ["%1_handler","SR_Mag_Stasis_Grenade"], -1])] call CBA_fnc_removeEventHandler;
		...
		if ("SR_Mag_Tanglefoot_Grenade" in (magazines player)) then {
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Tanglefoot_Grenade"], -1]) == -1) then {
				missionNamespace setVariable [format ["%1_handler","SR_Mag_Tanglefoot_Grenade"], ["ace_firedPlayer", {
					// params ["_unit", "_weapon", "_muzzle", "_mode", "_ammo", "_magazine", "_projectile", "_gunner"];
					_weapon = (_this select 1);
					if (_weapon == "Throw") then {
						_projectile = (_this select 6);
			...
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Tanglefoot_Grenade"], -1]) != -1) then {
				["ace_firedPlayer", (missionNamespace getVariable [format ["%1_handler","SR_Mag_Tanglefoot_Grenade"], -1])] call CBA_fnc_removeEventHandler;
		...
		if ("SR_Mag_Antigrav_Grenade" in (magazines player)) then {
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Antigrav_Grenade"], -1]) == -1) then {
				missionNamespace setVariable [format ["%1_handler","SR_Mag_Antigrav_Grenade"], ["ace_firedPlayer", {
					// params ["_unit", "_weapon", "_muzzle", "_mode", "_ammo", "_magazine", "_projectile", "_gunner"];
					_weapon = (_this select 1);
					if (_weapon == "Throw") then {
						_projectile = (_this select 6);
			...
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Antigrav_Grenade"], -1]) != -1) then {
				["ace_firedPlayer", (missionNamespace getVariable [format ["%1_handler","SR_Mag_Antigrav_Grenade"], -1])] call CBA_fnc_removeEventHandler;
		...
		if ("SR_Mag_Vortex_Grenade" in (magazines player)) then {
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Vortex_Grenade"], -1]) == -1) then {
				missionNamespace setVariable [format ["%1_handler","SR_Mag_Vortex_Grenade"], ["ace_firedPlayer", {
					// params ["_unit", "_weapon", "_muzzle", "_mode", "_ammo", "_magazine", "_projectile", "_gunner"];
					_weapon = (_this select 1);
					if (_weapon == "Throw") then {
						_projectile = (_this select 6);
			...
			if ((missionNamespace getVariable [format ["%1_handler","SR_Mag_Vortex_Grenade"], -1]) != -1) then {
				["ace_firedPlayer", (missionNamespace getVariable [format ["%1_handler","SR_Mag_Vortex_Grenade"], -1])] call CBA_fnc_removeEventHandler;
